...
_G.packer_plugins = {
  ...
  ["deoplete.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/deoplete.nvim",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/ultisnips",
  ...
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
  ...
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-snippets",
